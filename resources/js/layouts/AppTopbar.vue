...
<!-- <template>
    <div class="layout-topbar">
        <div class="layout-topbar-start">
            <button class="topbar-menu-button p-link" @click="$emit('menuToggle')">
                <i class="pi pi-bars"></i>
            </button>
        </div>
        ...
        <div class="layout-topbar-end">
            <div class="flex align-items-center gap-3">
                <button class="p-link topbar-button">
                    <i class="pi pi-bell"></i>
                </button>
                <div class="flex align-items-center gap-2">
                    <Avatar label="AG" size="normal" style="background-color: #4caf50; color: #ffffff" />
                    <span class="font-medium">Ahmed Ghaj</span>
                </div>
            </div>
        </div>
    </div>
