...
<template>
    ...
    <div
        class="surface-ground align-items-center justify-content-center flex min-h-screen min-w-[100vw] overflow-hidden p-3"
    >
        <div
            class="w-8 sm:w-6 md:w-4 lg:w-5"
            style="
                border-radius: 56px;
                padding: 0.3rem;
        ...
        >
            <div
                class="surface-card px-5 py-8 sm:px-8"
            ...
            >
                <div class="mb-5 text-center">
                    ...
                    <a class="flex w-full items-center justify-center" href="/">
                        <img
                            :src="logo"
                            alt="EDFS Logo"
                            class="mr-2 h-12 w-auto"
                        />
                    </a>
                    <div class="text-900 mb-3 text-3xl font-medium">
                        Welcome to EDFS!
                    </div>
                    <span class="text-600 line-height-3 font-medium"
                ...
                >
                    <div class="flex-column flex gap-3">
                        ...
                        <div
                            class="align-items-center justify-content-between mt-3 flex"
                        >
                            ...
                            <a
                                class="cursor-pointer font-medium text-blue-500 no-underline"
                                >Forgot password?</a
                            >
                        </div>
