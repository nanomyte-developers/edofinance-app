<!-- resources/js/pages/admin/expenditure-control/show.vue -->
<script setup>
...
const openRejectModal = () => {
    if (!isReadyForApproval.value) {
        ...
        errorMessage.value = `This voucher has status "${getStatusDisplayName(props.voucher.status)}" and must be "Forwarded from FA" before Expenditure Control can reject it.`;
        showErrorModal.value = true;
        return;
    }
...
const handleReject = () => {
    ...
    router.post(`/expenditure-control/vouchers/${props.voucher.id}/reject`, {
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head :title="`Expenditure Control - ${voucher.voucher_number}`" />
        <Toast />
        ...
        <div class="mb-4 flex align-items-center justify-content-between flex-wrap gap-3">
            <div class="flex align-items-center gap-3">
                ...
                <div class="flex align-items-center gap-2">
                    ...
                    <h1 class="text-2xl font-semibold m-0">Expenditure Control Review</h1>
                </div>
            </div>
                ...
                <div class="flex align-items-center gap-2">
                    ...
                    <div>
                        ...
                        <div class="text-sm mt-1">
                            ...
                            Only vouchers with status <strong>"Forwarded from FA"</strong> can be processed by Expenditure Control.
                        </div>
                    </div>
                </div>
            </Message>
                                ...
                                <div class="field mb-3">
                                    ...
                                    <div v-else class="bg-yellow-50 border-round p-3">
                                        <div class="flex align-items-center gap-2">
                                            ...
                                            <span>Bank will be assigned by Accountant General</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <template #content>
                        <div class="flex flex-column gap-3">
                            ...
                            <div class="flex justify-content-between align-items-center">
                                ...
                                <span v-else class="text-yellow-600">Pending AG Assignment</span>
                            </div>
                        </div>
                    </template>
                </Card>
        ...
        >
            <div class="flex flex-column gap-3">
                ...
                <div v-if="voucher.bank_activity" class="border-round bg-blue-50 p-3">
                    <div class="flex align-items-center gap-2 mb-2">
                        <i class="pi pi-building text-blue-600"></i>
                        <span class="font-semibold">Destination Bank:</span>
                    </div>
                    <div class="text-sm">
                ...
                <div v-else class="border-round bg-yellow-50 p-3">
                    <div class="flex align-items-center gap-2">
                        <i class="pi pi-info-circle text-yellow-600"></i>
                        <span class="text-sm">Bank will be assigned by Accountant General.</span>
                    </div>
                </div>
