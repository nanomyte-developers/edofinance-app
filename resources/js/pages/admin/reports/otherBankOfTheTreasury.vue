...
const breadcrumbs = [{ title: 'Reports' }, { title: 'Note 24.3' }, { title: 'Other Bank of the Treasury' }];
</script>

<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head title="Other Bank of the Treasury" />

        <Card class="report-card">
            <template #content>
                <div class="text-center mb-6">
                    <h3 class="text-lg font-bold uppercase underline">Notes to GPFS for the Year Ended 31st December, 2025 contd.</h3>
                    <h4 class="text-md font-bold mt-2 uppercase text-green-800">
                        NOTE 24.3: OTHER BANK OF THE TREASURY
                    </h4>
                </div>

                <DataTable :value="balanceData" responsiveLayout="scroll" class="p-datatable-gridlines p-datatable-sm custom-report-table">


                    <Column header="">
                        <template #body="{ data }">
                            <span class="uppercase text-xs">{{ data.description }}</span>
                        </template>
                    </Column>
                    ...
                    <ColumnGroup type="footer">
                        <Row>
                            <Column footer="TOTAL" :colspan="3" footerStyle="text-align:center; font-weight:bold; background-color: #f8fafc;" />
                ...
                <div class="mt-8 text-center text-xs text-gray-500 italic">
                    EDO STATE GOVERNMENT AUDITED GPFS 2024 | www.edostate.gov.ng
                </div>
            </template>
        </Card>
    </AppLayout>
