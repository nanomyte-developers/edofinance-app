...
// Navigate to generate ledger for specific account
// const generateLedger = (cashbook) => {
//     const url = `/cashbook/generate/${cashbook.month_id}/${cashbook.year}`;
//     // You might want to pass the bank_activities_id as well
//     window.location.href = url + `?account_id=${cashbook.bank_activities_id}`;
// };

// // Navigate to view ledger
// const viewLedger = (cashbook) => {
//     router.visit(`/cashbook/${cashbook.id}/ledger`);
// };
...
//         // Call backend to generate entries
...
//             severity: 'success',
//             summary: 'Success',
//             detail: 'Cashbook entries generated successfully',
//             life: 3000,
//         });
...
//             severity: 'error',
//             summary: 'Error',
//             detail: 'Failed to generate ledger entries',
//             life: 3000,
//         });
//     } finally {
...
const generateLedger = async (cashbook) => {
    ...
    try {
        const response = await axios.post(`/cashbook/${cashbook.id}/generate-entries`);
...
const viewLedger = (cashbook) => {
    // Navigate to the cashbook entries view
    router.visit(
                ...
                <template #start>
                    <div>
                        <Button
                            ...
                            v-tooltip.top="'Back to Months'"
                        />
                        <h5 class="m-0">{{ month_name }} - {{ year?.name }}</h5>
                        ...
                        <template #footer>
                            <!-- <div class="justify-content-between flex gap-2">
                                <Button
                                    ...
                                    :disabled="cashbook.status === 'closed'"
                                    v-tooltip.top="'Generate ledger entries'"
                                />
                                <Button
                                    label="Ledger"
                                    icon="pi pi-eye"
                                    ...
                                    :disabled="
                                        ...
                                        cashbook.entries.length === 0
                                    "
                                    v-tooltip.top="'View detailed ledger'"
                                />
                            </div> -->
                            <div class="justify-content-between flex gap-2">
                                <Button
                                    ...
                                    "
                                    v-tooltip.top="
                                        'Generate ledger entries from receipts and vouchers'
                                    "
                                />
                                <Button
                                    label="View Cashbook"
                                    ...
                                    "
                                    v-tooltip.top="
                                        'View cashbook with accounting layout'
                                    "
                                />
                            </div>
                        </template>
