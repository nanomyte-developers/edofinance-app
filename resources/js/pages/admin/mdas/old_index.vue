...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <Card>
            ...
            <template #content>
                ...
                >
                    ...
                    <Column
                        field="administrative_sectors"
                        header="Admin Sectors"
                        headerStyle="width: 20%"
                        :sortable="true"
                    >
                        <template #body="slotProps">
                            <div class="flex-column flex gap-1">
                                ...
                                >
                                    ...
                                    <div class="mt-1">
                                        <Chip
                                            v-for="sector in getMdaAdministrativeSector(
                                                slotProps.data,
                                            ).sectors.slice(0, 2)"
                                            :key="sector.id"
                                            :label="sector.code"
                        ...
                        <template #body="slotProps">
                            <div class="justify-content-center flex gap-2">
                                <Button
                                    ...
                                    text
                                    rounded
                                    v-tooltip.top="'View All Sectors'"
                ...
                <div
                    ...
                    v-if="mdaData.total > paginatorRows"
                >
                    <Paginator
                        :rows="paginatorRows"
        ...
        <Dialog
            ...
            :style="{ width: '700px' }"
            :header="`Sectors for ${currentMda?.name || 'MDA'}`"
            :modal="true"
        >
        ...
        <Dialog
            v-model:visible="showAdminSectorDetailModal"
            :style="{ width: '800px' }"
            :header="`Administrative Sectors for ${currentMda?.name || 'MDA'}`"
            :modal="true"
        >
            <div v-if="currentAdminSector">
                <div class="mb-6 rounded-lg bg-blue-50 p-4">
                    <div
                        class="justify-content-between align-items-center mb-2 flex"
                    >
                        <h3 class="text-lg font-bold text-blue-700">
                            Administrative Code
                        </h3>
                        <Tag
                            :value="currentAdminSector.code.code"
                            severity="info"
                        />
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <Tag
                                :value="
                                    currentAdminSector.code.status
                                        ? 'Active'
                                        : 'Inactive'
                                "
                                :severity="
                ...
                <div class="mb-4">
                    ...
                    >
                        ...
                        <Badge
                            :value="currentAdminSector.sectorCount"
                            severity="info"
                        />
                    </div>

                    <DataTable
                        :value="currentAdminSector.sectors"
                        stripedRows
                        :scrollable="true"
                        scrollHeight="300px"
                ...
                <div class="justify-content-end mt-6 flex gap-3">
                    <Button
                        label="Close"
                        icon="pi pi-times"
                        @click="showAdminSectorDetailModal = false"
                    />
                </div>
            </div>
        ...
        >
            <form @submit.prevent="saveMda" class="mt-2 flex flex-col gap-4">
                ...
                <div class="w-full">
                    ...
                    >
                    <Dropdown
                        id="administrative_code_id"
                        v-model="administrative_code_id"
                        :options="administrativeCodesOptions"
                        optionLabel="label"
                        optionValue="value"
                        :class="{ 'p-invalid': adminCodeError }"
                    ...
                    <small class="text-500"
                        >Link this MDA to an administrative code for sector
                        assignment</small
                    >
                </div>
                ...
                <div class="w-full">
                    <label for="location" class="mb-2 block font-semibold"
                        >Location/Address (Optional)</label
                    >
                    <Textarea
                        id="location"
                        v-model="location"
        ...
        <!-- EDIT MDA DIALOG -->
        <Dialog
            v-model:visible="showEditMdaModal"
            :style="{ width: '550px' }"
            :header="`Edit MDA: ${currentMda?.name || ''}`"
            :modal="true"
            class="p-fluid"
        >
            <form @submit.prevent="saveMda" class="mt-2 flex flex-col gap-4">
                <div class="w-full">
                    <label for="edit_name" class="mb-2 block font-semibold"
                        >Full Name *</label
                    >
                    <InputText
                        id="edit_name"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label for="edit_code" class="mb-2 block font-semibold"
                            >Short Code *</label
                        >
                        <InputText
                            id="edit_code"
                ...
                <div class="w-full">
                    <label
                        for="edit_administrative_code_id"
                        class="mb-2 block font-semibold"
                        >Administrative Code</label
                    >
                    <Dropdown
                        id="edit_administrative_code_id"
                        v-model="administrative_code_id"
                        :options="administrativeCodesOptions"
                        optionLabel="label"
                        optionValue="value"
                ...
                <div class="w-full">
                    <label for="edit_location" class="mb-2 block font-semibold"
