<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <Card>
            <template #title>
                <div class="align-items-center justify-content-between flex">
                    <div class="align-items-center flex gap-2">
                        ...
                        <Badge :value="paginatorTotalRecords" severity="info" />
                    </div>
            ...
            <template #content>
                <DataTable :value="auditVoucherData.data" dataKey="id" stripedRows responsiveLayout="scroll"
                    class="p-datatable-sm" :emptyMessage="'No vouchers pending audit review.'" paginator
                    :rows="paginatorRows" :totalRecords="paginatorTotalRecords"
                    :first="(paginatorCurrentPage - 1) * paginatorRows" @page="onPageChange">
