<!-- resources/js/pages/admin/accountant-general/show.vue -->
<script setup>
...
// Check if voucher is ready for AG approval
...
const openApproveModal = () => {
    if (!isReadyForApproval.value) {
        ...
        errorMessage.value = `This voucher has status "${getStatusDisplayName(props.voucher.status)}" and must be "Forwarded from EC" before Accountant General can process it.`;
...
const openRejectModal = () => {
    if (!isReadyForApproval.value) {
        ...
        errorMessage.value = `This voucher has status "${getStatusDisplayName(props.voucher.status)}" and must be "Forwarded from EC" before Accountant General can reject it.`;
        showErrorModal.value = true;
        return;
    }
...
const handleApprove = () => {
    ...
    router.post(`/accountant-general/vouchers/${props.voucher.id}/approve`, {}, {
        preserveScroll: true,
        onSuccess: (response) => {
            ...
            successMessage.value = response.message || `Voucher has been successfully forwarded to Management Account Section.`;
...
const handleReject = () => {
    ...
    router.post(`/accountant-general/vouchers/${props.voucher.id}/reject`, {
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head :title="`Accountant General - ${voucher.voucher_number}`" />
        <Toast />
        ...
        <div class="mb-4 flex align-items-center justify-content-between flex-wrap gap-3">
            <div class="flex align-items-center gap-3">
                ...
                <div class="flex align-items-center gap-2">
                    ...
                    <h1 class="text-2xl font-semibold m-0">Accountant General Review</h1>
                </div>
            </div>
        ...
        <div v-if="!isReadyForApproval" class="mb-4">
            <Message severity="warn" :closable="false">
                <div class="flex align-items-center gap-2">
                    ...
                    <div>
                        <strong>Voucher Not Ready for Accountant General Review</strong>
                        <div class="text-sm mt-1">
                            This voucher has status <strong>{{ getStatusDisplayName(voucher.status) }}</strong>. 
                            Only vouchers with status <strong>"Forwarded from EC"</strong> can be processed by Accountant General.
                        </div>
                    </div>
                </div>
            </Message>
                ...
                <div class="flex align-items-center gap-3 flex-wrap">
                    ...
                    <div>
                        ...
                        <div class="text-sm mt-1">
                            ...
                            Once approved, this voucher will go to <strong>Management Account Section (MAS)</strong> for final processing.
                        </div>
                    </div>
                </div>
            </Message>
        ...
        <div class="grid">
            ...
            <div class="col-12 lg:col-8">
                <!-- Similar voucher details card as previous implementations -->
                    ...
                    <template #content>
                        <div class="flex flex-column gap-3">
                            ...
                            <div class="flex justify-content-between align-items-center">
                                ...
                                <Tag value="Accountant General (AG)" severity="warning" />
                            </div>
                            <div class="flex justify-content-between align-items-center">
                            ...
                            <div class="flex justify-content-between align-items-center">
                                ...
                                <Tag value="Management Account Section (MAS)" severity="info" icon="pi pi-arrow-right" />
                            </div>
                        </div>
                    </template>
                </Card>
        ...
        <!-- Success, Approval, Rejection, Error, Document Viewer Modals (same as previous implementations) -->
        <!-- Success Modal -->
        <Dialog
...
<style scoped>
/* Same styles as previous implementations */
