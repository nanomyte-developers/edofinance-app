...
- Inertia.js components should be placed in the ___SINGLE_BACKTICK___{{ $assist->inertia()->pagesDirectory() }}___SINGLE_BACKTICK___ directory unless specified differently in the JS bundler (___SINGLE_BACKTICK___vite.config.js___SINGLE_BACKTICK___).
